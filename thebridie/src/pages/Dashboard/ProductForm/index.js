...
const emptyProduct = {
  name: '', nameEn: '', sku: '', category: 'bundles', price: '', stock: '',
            ...
            <div>
              ...
              <div className="pf-field">
                ...
                <input className="form-input" name="name" value={form.name} onChange={onInput}
                  placeholder={ar('مثال: باقة الشلة الثلاثية', 'e.g. The Squad Bundle')} required />
              </div>
              <div className="pf-field">
            ...
            <div>
              ...
              <div className="pf-field">
                ...
                <input className="form-input" name="nameEn" value={form.nameEn} onChange={onInput}
                  dir="ltr" placeholder="e.g. The Squad Bundle" />
              </div>
              <div className="pf-field">
          ...
          <div className="pf-grid-3">
            <div className="pf-field">
              ...
              <input className="form-input" name="sku" value={form.sku} onChange={onInput}
                dir="ltr" placeholder="BRD-BUN-001" />
            </div>
            <div className="pf-field">
